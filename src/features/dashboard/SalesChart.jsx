    ...
    <StyledSalesChart>
      ...
      <ResponsiveContainer height={300} width="100%">
        <AreaChart data={data} >
          ...
          <Area dataKey="totalSales" strokeWidth={2} name="Total sales" type="monotone" stroke={colors.totalSales.stroke} fill={colors.totalSales.fill} unit="$" />
          <Area dataKey="extrasSales" strokeWidth={2} name="Total sales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} unit="$" />
        </AreaChart>
      </ResponsiveContainer>
    </StyledSalesChart>
  )
