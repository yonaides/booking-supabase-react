...
const CabinRow = ({ cabin }) => {
  ...
  return (
    ...
    <Table.Row>
      ...
      <div>
        <button onClick={handlerDuplicate} disabled={isCreating}> <HiSquare2Stack /> </button>
        <Modal>
        ...
        <Menus.Menu>
          ...
          <Menus.List id={cabinId}>
            <Menus.Button icon={<HiSquare2Stack />} onClick={handlerDuplicate}>Duplicate</Menus.Button>
